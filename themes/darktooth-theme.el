...
(let (
      ...
      (darktooth-dark_yellow    (if (display-graphic-p)  "#D79921" "color-3"))
  ...
  (custom-theme-set-faces
   ...
   ;; UI
   `(default                                   ((t (:foreground ,darktooth-light0 :background ,darktooth-dark0_soft))))
   ...
   `(fringe                                    ((t (:background ,darktooth-dark0_soft))))
   ...
   `(minibuffer-prompt                         ((t (:foreground ,darktooth-turquoise4 :background ,darktooth-dark0_soft :bold nil))))
   ...
   `(company-tooltip-annotation-selection      ((t (:foreground ,darktooth-bright_blue :background ,darktooth-faded_blue))))
